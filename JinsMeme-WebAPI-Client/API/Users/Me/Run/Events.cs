...
namespace JinsMeme_WebAPI_Client.API.Users.Me.Run
{
    /**
     * JINS MEME RUN NEXT APPイベント取得
     * https://jins-meme.github.io/sdkdoc/api/get_runnext.html#jins-meme-run-next-appイベント取得
     */
    ...
    public class Events
    {
        ...
        public class Request : IRequestable
        {
            ...
            public HttpRequestMessage ToHttpRequestMessage()
            {
                ...
                var builder = new UriBuilder(Constants.URL.API.Users.Me.Run.Events);
